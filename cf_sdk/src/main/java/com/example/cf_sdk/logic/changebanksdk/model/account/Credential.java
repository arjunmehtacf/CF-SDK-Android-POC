...
public class Credential implements Parcelable {
    ...
    @SerializedName("mfa")
    private Boolean mMfa;

    @SerializedName("optionalMfa")
    private Boolean mOptionalMfa;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(mOptionalMfa);
        dest.writeString(mUpdatedAt);
        dest.writeString(mValueMask);
        dest.writeValue(mSize);
        dest.writeString(mGuid);
        dest.writeString(mLabel);
        dest.writeValue(mOptional);
        dest.writeString(mInstitutionGuid);
        dest.writeString(mValueIdentifier);
        dest.writeInt(mFieldTypeName == null ? -1 : mFieldTypeName.ordinal());
        dest.writeList(mOptions);
        dest.writeString(mFieldName);
        dest.writeValue(mMfa);
        dest.writeString(mCreatedAt);
        dest.writeString(mEscaped);
        dest.writeString(mAnswerFieldType);
        dest.writeValue(mFieldType);
        dest.writeValue(mDisplayOrder);
        dest.writeString(mMetaData);
        dest.writeValue(mMaxLength);
        dest.writeValue(mEditable);
        dest.writeString(mCredentialGuid);
        dest.writeString(mValue);
    }

    protected Credential(Parcel in) {
        mDisplayName = in.readString();
        mOptionalMfa = (Boolean) in.readValue(Boolean.class.getClassLoader());
        mUpdatedAt = in.readString();
        mValueMask = in.readString();
        mSize = (Integer) in.readValue(Integer.class.getClassLoader());
        mGuid = in.readString();
        mLabel = in.readString();
        mOptional = (Boolean) in.readValue(Boolean.class.getClassLoader());
        mInstitutionGuid = in.readString();
        mValueIdentifier = in.readString();
        int tmpMFieldTypeName = in.readInt();
        mFieldTypeName = tmpMFieldTypeName == -1 ? null : CredentialType.values()[tmpMFieldTypeName];
        mOptions = new ArrayList<>();
        in.readList(this.mOptions, Option.class.getClassLoader());
        mFieldName = in.readString();
        mMfa = (Boolean) in.readValue(Boolean.class.getClassLoader());
        mCreatedAt = in.readString();
        mEscaped = in.readString();
        mAnswerFieldType = in.readString();
        mFieldType = (Integer) in.readValue(Integer.class.getClassLoader());
        mDisplayOrder = (Integer) in.readValue(Integer.class.getClassLoader());
        mMetaData = in.readString();
        mMaxLength = (Integer) in.readValue(Integer.class.getClassLoader());
        mEditable = (Boolean) in.readValue(Boolean.class.getClassLoader());
        mCredentialGuid = in.readString();
