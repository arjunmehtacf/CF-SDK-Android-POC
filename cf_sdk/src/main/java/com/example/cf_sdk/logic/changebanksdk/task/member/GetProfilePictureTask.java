...
public class GetProfilePictureTask extends SingleUseCase<ProfilePictureParameters, FileResponse> {

    private AuthenticationDatasource mAuthenticationDatasource;
    private MemberDatasource mMemberRepository;

    @Inject
    public GetProfilePictureTask(
    ...
    @Override
    protected Single<FileResponse> buildUseCaseObservable(final ProfilePictureParameters documentParameters) {
        return mAuthenticationDatasource.getSession()
                .flatMap(new Function<Session, SingleSource<? extends FileResponse>>() {
                    ...
                    public SingleSource<? extends FileResponse> apply(Session session) throws Exception {
                        ...
                        documentParameters.setMemberId(session.getCustomerNumber());
                        return mMemberRepository.getProfilePicture(documentParameters)
