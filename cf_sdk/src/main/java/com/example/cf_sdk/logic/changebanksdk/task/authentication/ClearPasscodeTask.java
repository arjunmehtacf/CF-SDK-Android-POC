...
/**
 *
 * Task to clear Passcode
 */

public class ClearPasscodeTask extends CompletableUseCase<Parameters> {

    private AuthenticationDatasource mAuthenticationRepository;

    @Inject
    public ClearPasscodeTask(@Named("repository") AuthenticationDatasource authenticationRepository,
    ...
    protected Completable buildUseCaseObservable(Parameters parameters) {
        return mAuthenticationRepository.clearPasscode();
    }
}
