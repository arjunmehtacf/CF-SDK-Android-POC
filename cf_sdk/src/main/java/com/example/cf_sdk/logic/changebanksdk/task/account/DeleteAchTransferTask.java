...
/**
 *
 * Cancels an initiated AchTransfer.
 */

public class DeleteAchTransferTask extends SingleUseCase<DeleteAchTransferParameters, AchTransfer> {

    private AccountDatasource mAccountDatasource;
    private AuthenticationDatasource mAuthenticationDatasource;

    @Inject
    public DeleteAchTransferTask(@Named("repository") AccountDatasource accountDatasource,
    ...
    @Override
    protected Single<AchTransfer> buildUseCaseObservable(final DeleteAchTransferParameters parameters) {
        return mAuthenticationDatasource.getSession()
                .flatMap(new Function<Session, SingleSource<? extends AchTransfer>>() {
                    ...
                    public SingleSource<? extends AchTransfer> apply(Session session) throws Exception {
                        ...
                        return mAccountDatasource.deleteAchTransfer(parameters);
                    }
                });
    }
}
