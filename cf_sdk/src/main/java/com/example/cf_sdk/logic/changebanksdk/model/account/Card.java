...
public class Card implements Parcelable {
    ...
    private Boolean mIsCCProcessor;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.mLast4Pan);
        dest.writeString(this.mExpirationDate);
        dest.writeString(this.mAdminNumber);
    ...
    protected Card(Parcel in) {
        ...
        this.mLast4Pan = in.readString();
        this.mExpirationDate = in.readString();
        this.mAdminNumber = in.readString();
        int tmpMStatus = in.readInt();
        this.mStatus = tmpMStatus == -1 ? null : CardStatus.values()[tmpMStatus];
