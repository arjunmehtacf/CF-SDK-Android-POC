...
public class VerifyBatchAdminNumberTask extends CompletableUseCase<CreateBatchListMemberParameters> {
    private final MemberDatasource mMemberRepository;

    @Inject
    public VerifyBatchAdminNumberTask(
    ...
    protected Completable buildUseCaseObservable(final CreateBatchListMemberParameters parameters) {
        return mMemberRepository.getAdminNumberAvailability(parameters);
    }
}
